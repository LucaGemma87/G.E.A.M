...
#include <gazebo-4.1/gazebo/transport/TransportTypes.hh>
#include <gazebo-4.1/gazebo/common/Plugin.hh>
#include <gazebo-4.1/gazebo/common/Events.hh>
#include <gazebo-4.1/gazebo/physics/physics.hh>
