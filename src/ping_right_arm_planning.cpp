...
{  
 ...
 // int decision = 2; 
 // 
 // right_arm_planning_srv.request.goal.var_roll_wrist=1.25;
 // right_arm_planning_srv.request.goal.var_pitch_wrist=1.25;
 // right_arm_planning_srv.request.goal.var_yaw_wrist=1.25;
 // right_arm_planning_srv.request.goal.decision=(int)decision;
