  ...
  Data_Logger(ros::NodeHandle nh) : nh_(nh), priv_nh_("~")
   {
     ...
     data_logger_srv_ = nh_.advertiseService(nh_.resolveName("left_hand_arm_data_logger_srv"), &Data_Logger::serviceCallback, this);
...
bool Data_Logger::serviceCallback(grasp_estimator::DataAcquiring::Request &request, grasp_estimator::DataAcquiring::Response &response)
{
  ...
  double left_hand_synergy_joint_state_position;
  double left_hand_synergy_joint_state_velocity;
  double left_hand_synergy_joint_state_effort;
  double current_error;
  //double max_ticks = 15000;
  // Wrench left arm initialization
  ...
  if(data_request.request.activation==(int)1)
  {
    ...
    ///// acquiring joint left hand
    ROS_INFO("Starting acquiring joint state left hand ");
    ...
    ////// Position motor left hand:

    // Now for simulation I use topic /left_hand/joint_trajectory_controller/state with  actual: positions: [value]
    ...
    left_hand_synergy_joint_state_position=CurrentState_Hand_ConstPtr->position[28]; 
    left_hand_synergy_joint_state_velocity=CurrentState_Hand_ConstPtr->velocity[28]; 
    left_hand_synergy_joint_state_effort=CurrentState_Hand_ConstPtr->effort[28]; 
    ...
    //// Acquiring the wrench by simulated sensor on left arm (Wrench Stamped)
    ...
    data_request.response.data.hand_joint_curr_state.header=CurrentState_Hand_ConstPtr->header;
    data_request.response.data.hand_joint_curr_state.name=CurrentState_Hand_ConstPtr->name;
    data_request.response.data.hand_joint_curr_state.position=CurrentState_Hand_ConstPtr->position;
    //data_request.response.data.hand_joint_curr_state.position=CurrentState_Hand_ConstPtr->position;
    data_request.response.data.hand_joint_curr_state.velocity=CurrentState_Hand_ConstPtr->velocity;
    data_request.response.data.hand_joint_curr_state.effort=CurrentState_Hand_ConstPtr->effort;
    ...
    data_request.response.data.hand_index_distal_link=left_hand_index_distal_link_msgs;
    ...
    data_request.response.data.hand_index_knuckle_link=left_hand_index_knuckle_link_msgs;
    ...
    data_request.response.data.hand_index_middle_link=left_hand_index_middle_link_msgs;
    ...
    data_request.response.data.hand_index_proximal_link=left_hand_index_proximal_link_msgs;
    ...
    data_request.response.data.hand_little_distal_link=left_hand_little_distal_link_msgs;
    ...
    data_request.response.data.hand_little_knuckle_link=left_hand_little_knuckle_link_msgs;
    ...
    data_request.response.data.hand_little_middle_link=left_hand_little_middle_link_msgs;
    ...
    data_request.response.data.hand_little_proximal_link=left_hand_little_proximal_link_msgs;
    ...
    data_request.response.data.hand_middle_distal_link=left_hand_middle_distal_link_msgs;
    ...
    data_request.response.data.hand_middle_knuckle_link=left_hand_middle_knuckle_link_msgs;
    ...
    data_request.response.data.hand_middle_middle_link=left_hand_middle_middle_link_msgs;
    ...
    data_request.response.data.hand_middle_proximal_link=left_hand_middle_proximal_link_msgs;
    ...
    data_request.response.data.hand_ring_distal_link=left_hand_ring_distal_link_msgs;
    ...
    data_request.response.data.hand_ring_knuckle_link=left_hand_ring_knuckle_link_msgs;
    ...
    data_request.response.data.hand_ring_middle_link=left_hand_ring_middle_link_msgs;
    ...
    data_request.response.data.hand_ring_proximal_link=left_hand_ring_proximal_link_msgs;
    ...
    data_request.response.data.hand_thumb_distal_link=left_hand_thumb_distal_link_msgs;
    ...
    data_request.response.data.hand_thumb_knuckle_link=left_hand_thumb_knuckle_link_msgs;
    ...
    data_request.response.data.hand_thumb_proximal_link=left_hand_thumb_proximal_link_msgs;
    
    //Position motor left hand response:
    data_request.response.data.hand_synergy_joint_state_position=left_hand_synergy_joint_state_position;
    data_request.response.data.hand_synergy_joint_state_velocity=left_hand_synergy_joint_state_velocity;
    data_request.response.data.hand_synergy_joint_state_effort=left_hand_synergy_joint_state_effort;
    data_request.response.data.hand_error_position=current_error;
    
    // Wrench on the left arm 7 link
    data_request.response.data.arm_wrench_stamped.header=left_arm_wrench_stamped_ConstPtr->header;
    data_request.response.data.arm_wrench_stamped.wrench=left_arm_wrench_stamped_ConstPtr->wrench;
